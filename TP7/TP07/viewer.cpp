...
void Viewer::createTextures() {
  ...
  loadTexture(_texIds[0],"textures/normal01.jpg");
  loadTexture(_texIds[1],"textures/normal02.jpg");
  loadTexture(_texIds[2],"textures/normal03.jpg");
}
...
void Viewer::createShaders() {
  ...
  _vertexFilenames.push_back("shaders/second-pass.vert");
  _fragmentFilenames.push_back("shaders/second-pass.frag");
  // ******************************
}
